  ...
  fields: [
    {
      ...
      fields: [
        ...
        { name: "title", type: "text", required: true, localized: true, label: "Card Title", admin: { description: "Card label, e.g. 'Call Us'." } },
        {
          name: "channel",
          type: "select",
          defaultValue: "none",
        ...
        { name: "value", type: "text", localized: true, label: "Display Value", admin: { description: "Text shown on the card when 'Contact type' is Custom (e.g. working hours), or the WhatsApp display label. Ignored for Phone/Email (filled from Brand & Identity)." } },
        ...
        { name: "note", type: "text", localized: true, label: "Sub-line", admin: { description: "Small line under the value, e.g. '24×7 patient helpline'." } },
      ],
    },
  ],
};
