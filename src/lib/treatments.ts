...
export const ivfFailure: Treatment = {
  ...
  faqs: [
    ...
    { q: "How important is embryo transfer timing?", a: "The timing of embryo transfer is important for implantation. Where indicated, supportive techniques such as embryo glue may also be used to help the embryo implant." },
