...
export const DOCTORS: Doctor[] = [
  {
    ...
    publications: [
      ...
      "Author — patient booklets on PCOS, conception and IVF (Gujarati & Hindi)",
      "Study comparing recombinant vs urinary FSH in controlled ovarian stimulation — International Journal of Infertility & Fetal Medicine",
