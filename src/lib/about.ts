...
export const ABOUT_DEFAULTS: AboutData = {
  hero: {
    ...
    headline: "Over three decades of fertility excellence — built on technology & trust",
    headlineItalic: "fertility excellence",
    paragraph:
      'Founded and led by the well-known experts of the Bavishi family — <a href="/doctors/himanshu-bavishi" style="color:var(--plum)">Dr. Himanshu Bavishi</a> &amp; <a href="/doctors/falguni-bavishi" style="color:var(--plum)">Dr. Falguni Bavishi</a> — all Bavishi Fertility Institute clinics offer meticulous attention of the highest order in a pleasant and avant-garde environment to make your treatment <a href="/simple-treatment" style="color:var(--plum)">Simple</a>, <a href="/safe-treatment" style="color:var(--plum)">Safe</a>, <a href="/smart-treatment" style="color:var(--plum)">Smart</a> and <a href="/success-benchmarks" style="color:var(--plum)">Successful</a>.',
  ...
  story: {
    ...
    paragraphs: [
      'From 1998 to the present day, our rich and cultural significance has given us some of the most remarkable accomplishments a fertility clinic can achieve. Bavishi Fertility Institute was formally established by <a href="/doctors/himanshu-bavishi"><strong style="color:var(--plum)">Dr. Himanshu Bavishi</strong></a> and <a href="/doctors/falguni-bavishi"><strong style="color:var(--plum)">Dr. Falguni Bavishi</strong></a> in <a href="/locations/ahmedabad" style="color:var(--plum);text-decoration:underline">Ahmedabad</a> with a simple but powerful belief: that world-class fertility care should be within every family\'s reach. Where every treatment is delivered with science, sincerity and a deep human touch. Today, our centres perform more than 3,000 <a href="/what-is-ivf" style="color:var(--plum);text-decoration:underline">IVF</a> cycles every year with one of the best results in the world.',
      'Bavishi Fertility Institute was ranked all India No. 1 in 2020 by Times of India and has been recognised as <strong style="color:var(--plum)">&ldquo;Best <a href="/what-is-ivf" style="color:var(--plum)">IVF</a> Chain in India &ndash; West&rdquo;</strong> by The Economic Times six times (2019, 2022, 2023, 2024, 2025 and 2026). A familial team that stands with you at every step of your fertility journey — welcoming, listening and advising patients before, during and after their journey is our priority.',
      'What began as a single clinic has grown into a multi-centre institute that pioneered <a href="/what-is-ivf" style="color:var(--plum);text-decoration:underline">IVF</a> in India, achieved national firsts, has been joined by second generation of Bavishi doctors — <a href="/doctors/parth-bavishi" style="color:var(--plum);text-decoration:underline">Dr. Parth Bavishi</a> and <a href="/doctors/janki-bavishi" style="color:var(--plum);text-decoration:underline">Dr. Janki Bavishi</a> more than a decade ago. The institute has also championed public awareness through books like \'Devna Didhela, Mangine Lidhela\', \'Vighnadod\', \'Aapnu Adbhut Sarjan\' and \'Your Miracle in Making\', and through initiatives such as the Divya Santan organisation, Jan Jagruti Abhiyan and Parivar Milan campaigns. Our values guide everything we do: <strong style="color:var(--plum)"><a href="/simple-treatment" style="color:var(--plum)">Simple</a>, <a href="/safe-treatment" style="color:var(--plum)">Safe</a>, <a href="/smart-treatment" style="color:var(--plum)">Smart</a> and <a href="/success-benchmarks" style="color:var(--plum)">Successful</a></strong>.',
    ],
  },
  atAGlance: [
    ...
    { n: "6×", l: "National Fertility Award winner (2019–2026)" },
  ],
  legacy: {
  ...
  milestones: [
    { y: "1998", t: "Bavishi Fertility Institute begins", d: '<a href="/doctors/himanshu-bavishi" style="color:var(--plum)">Dr. Himanshu</a> &amp; <a href="/doctors/falguni-bavishi" style="color:var(--plum)">Dr. Falguni Bavishi</a> establish Bavishi Fertility Institute (Test Tube Baby Clinic) in <a href="/locations/ahmedabad" style="color:var(--plum)">Ahmedabad</a>. Preimplantation Genetic Diagnosis (PGD) also launched the same year — bringing advanced genetic screening to Indian fertility care from the very start.' },
    ...
    { y: "2010", t: "Expanding to Mumbai & Delhi", d: 'Opened offices in <a href="/locations/mumbai" style="color:var(--plum)">Mumbai</a> and Delhi, taking trusted fertility care beyond <a href="/locations/ahmedabad" style="color:var(--plum)">Ahmedabad</a> for the first time.' },
    { y: "2009", t: "A national first", d: 'Birth of India\'s first baby through Vitrified Frozen Oocytes at Bavishi (<a href="/cryopreservation" style="color:var(--plum)">Cryopreservation</a>) — a milestone that shaped Indian reproductive medicine.' },
    { y: "2011", t: "Divya Santan & first book", d: "Founded the 'Divya Santan' organisation — an infertility patient support group — and published 'Devna Didhela, Mangine Lidhela' — sharing the stories of 111 test-tube-baby families." },
    { y: "2012", t: "Awareness through publishing", d: "Published 'Vighnadod' — a book on the infertility journey, problems and solutions for couples struggling to conceive." },
    { y: "2013", t: "Public awareness campaigns", d: "Launched massive 'Jan Jagruti Abhiyan' and 'Parivar Milan' — special awareness campaigns to support infertile couples and remove social stigma." },
    { y: "2014", t: "INSTAR founded", d: 'Dr Himanshu Bavishi founded INSTAR (Indian Society of Third Party Assisted Reproduction) as a founder president — advancing ethical standards in <a href="/egg-donation" style="color:var(--plum)">egg donation</a>, <a href="/sperm-donation" style="color:var(--plum)">sperm donation</a> and surrogacy programmes.' },
    ...
    { y: "2017", t: "International recognition", d: 'Received the \'Socrates Award — Rose of Paracelsus\' from the European Medical Association, and the Gujarat Chief Minister\'s \'Shreshti\' award to <a href="/doctors/himanshu-bavishi" style="color:var(--plum)">Dr. Himanshu</a> &amp; <a href="/doctors/falguni-bavishi" style="color:var(--plum)">Dr. Falguni Bavishi</a> for contributions to infertility treatment. Published \'Aapnu Adbhut Sarjan\' (Gujarati) and \'Your Miracle in Making\' (English) – a couple\'s guide to pregnancy.' },
    { y: "2018", t: "Surat centre & national awards", d: 'Started the <a href="/locations/surat" style="color:var(--plum)">Surat</a> centre. Received \'Best IVF Clinic Chain in India\' (Mid-Day) and \'Times Health Icon\' award. The book \'Devna Didhela Mangine Lidhela\' was adapted into a TV serial on infertility awareness, airing on Colours Gujarati channel.' },
    { y: "2019", t: "Best IVF Chain — West & first National Fertility Award", d: 'Awarded \'Best IVF Chain in India – West\' by The Economic Times and received the National Fertility Award for the first time (year 1 of 6). Expanded to <a href="/locations/vadodara" style="color:var(--plum)">Vadodara</a>.' },
    { y: "2020", t: "India's No.1 Fertility Clinic", d: 'Ahmedabad institute ranked No.1 fertility clinic across all of India by Times of India National Survey. <a href="/locations/bhuj" style="color:var(--plum)">Bhuj</a> clinic started.' },
    { y: "2021", t: "PGD-HLA Matching breakthrough", d: "Introduced PGD-HLA Matching technology for stem-cell donor matching and leukaemia treatment support — a highly specialised capability available in very few centres worldwide." },
    ...
    { y: "2025", t: "Nikol, Ahmedabad, Bhavnagar & fifth National Fertility Award", d: 'Opened the <a href="/locations/ahmedabad/nikol" style="color:var(--plum)">Nikol</a> centre in east <a href="/locations/ahmedabad" style="color:var(--plum)">Ahmedabad</a> and a new centre in <a href="/locations/bhavnagar" style="color:var(--plum)">Bhavnagar</a> — making expert fertility care accessible across the region. Received \'Best IVF Chain in India — West\' (The Economic Times) and the National Fertility Award for the fifth time (2019–2025).' },
    { y: "2026", t: "Anand, Varanasi & National Fertility Award, sixth time", d: 'Opened new centres in <a href="/locations/anand" style="color:var(--plum)">Anand</a> and <a href="/locations/varanasi" style="color:var(--plum)">Varanasi</a>, expanding our reach further. Received the \'Best IVF Chain in India – West\' award by The Economic Times for the sixth time (2019, 2022, 2023, 2024, 2025, 2026), and the National Fertility Award for the sixth time (2019–2026) — reinforcing Bavishi Fertility Institute\'s position as the nation\'s most trusted fertility network.' },
  ...
  trustPillars: [
    { icon: "Award", t: "30+ Years of Experience", d: 'Since 1998, a family-led institute that pioneered <a href="/what-is-ivf" style="color:var(--plum)">IVF</a> in India and has guided 30,000+ families to parenthood.' },
    { icon: "HeartPulse", t: "Outcomes That Matter", d: '3,000+ <a href="/what-is-ivf" style="color:var(--plum)">IVF</a> cycles a year with a focus on safe stimulation, best-quality embryos and healthy single pregnancies.' },
    { icon: "Users", t: "A Family of Specialists", d: 'Gynaecologists, obstetricians, embryologists, psychologists, nutritionists, consultants, coordinators and managers — exclusively dedicated to resolving patients\' issues and treating them. <a href="/doctors" style="color:var(--plum);text-decoration:underline">Meet our doctors</a> — shared infrastructure with more than 35+ years of experience.' },
    { icon: "Microscope", t: "World-Class Technology", d: 'Class 1000 <a href="/what-is-ivf" style="color:var(--plum)">IVF</a> labs — 10× cleaner than the international standard — with Latest gen ICSI, <a href="/cryopreservation" style="color:var(--plum)">vitrification</a> and PGT.' },
    ...
    { icon: "Sparkles", t: "Simple · Safe · Smart · Successful", d: 'When you choose Bavishi Fertility Institute, your choice is right. Only the most innovative and experienced fertility clinics can make complex <a href="/what-is-ivf" style="color:var(--plum)">IVF</a> treatment <a href="/simple-treatment" style="color:var(--plum)">simple</a>, <a href="/safe-treatment" style="color:var(--plum)">safe</a>, <a href="/smart-treatment" style="color:var(--plum)">smart</a> and <a href="/success-benchmarks" style="color:var(--plum)">successful</a> — and that\'s our \'EASY IVF\'.' },
  ],
  patientFirst: {
