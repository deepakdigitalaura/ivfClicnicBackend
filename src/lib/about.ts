...
export const ABOUT_DEFAULTS: AboutData = {
  ...
  story: {
    ...
    paragraphs: [
      ...
      'What began as a single clinic has grown into a multi-centre institute that pioneered <a href="/what-is-ivf" style="color:var(--plum);text-decoration:underline">IVF</a> in India, achieved national firsts, and today welcomes the second generation of Bavishi doctors — <a href="/doctors/parth-bavishi" style="color:var(--plum);text-decoration:underline">Dr. Parth Bavishi</a> and <a href="/doctors/janki-bavishi" style="color:var(--plum);text-decoration:underline">Dr. Janki Bavishi</a>. The institute has also championed public awareness through books like \'Devna Didhela, Mangine Lidhela\', \'Viknadog\', \'Aapnu Adbhut Sarjan\' and \'Your Miracle in Making\', and through initiatives such as the Divya Santan organisation, Jan Jagruti Abhiyan and Parivar Milan campaigns. Our values guide everything we do: <strong style="color:var(--plum)"><a href="/simple-treatment" style="color:var(--plum)">Simple</a>, <a href="/safe-treatment" style="color:var(--plum)">Safe</a>, <a href="/smart-treatment" style="color:var(--plum)">Smart</a> and <a href="/success-benchmarks" style="color:var(--plum)">Successful</a></strong>.',
    ],
  },
  atAGlance: [
  ...
  trustPillars: [
    ...
    { icon: "Microscope", t: "World-Class Technology", d: 'Class 1000 <a href="/what-is-ivf" style="color:var(--plum)">IVF</a> labs — 10× cleaner than the international standard — with time-lapse imaging, <a href="/cryopreservation" style="color:var(--plum)">vitrification</a> and PGT.' },
