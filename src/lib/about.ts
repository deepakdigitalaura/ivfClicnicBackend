...
export const ABOUT_DEFAULTS: AboutData = {
  ...
  milestones: [
    ...
    { y: "2005", t: "Full-service fertility institute", d: 'Established a comprehensive fertility institute with complete facilities in <a href="/locations/ahmedabad" style="color:var(--plum)">Ahmedabad</a>.' },
    ...
    { y: "2008", t: "Expanding to Mumbai & Surat", d: 'Opened offices in <a href="/locations/mumbai" style="color:var(--plum)">Mumbai</a> and <a href="/locations/surat" style="color:var(--plum)">Surat</a>, taking trusted fertility care beyond <a href="/locations/ahmedabad" style="color:var(--plum)">Ahmedabad</a> for the first time.' },
    { y: "2009", t: "A national first", d: 'Birth of India\'s first baby through Vitrified Frozen Oocytes (<a href="/cryopreservation" style="color:var(--plum)">Cryopreservation</a>) — a milestone that shaped Indian reproductive medicine.' },
    ...
    { y: "2014", t: "INSTAR founded", d: 'Founded INSTAR (Indian Society of Third Party Assisted Reproduction) — advancing ethical standards in <a href="/egg-donation" style="color:var(--plum)">egg donation</a>, <a href="/sperm-donation" style="color:var(--plum)">sperm donation</a> and surrogacy programmes.' },
    ...
    { y: "2017", t: "International recognition", d: 'Received the \'Socrates Award — Rose of Paracelsus\' from the European Medical Association, the IMA Gujarat \'Excellence in the Field of Medicine\' award (<a href="/doctors/himanshu-bavishi" style="color:var(--plum)">Dr. Himanshu Bavishi</a> — first IVF graduate recipient), and the Gujarat Chief Minister\'s \'Shreshtha\' award to <a href="/doctors/himanshu-bavishi" style="color:var(--plum)">Dr. Himanshu</a> &amp; <a href="/doctors/falguni-bavishi" style="color:var(--plum)">Dr. Falguni Bavishi</a> for contributions to infertility treatment. Also published \'Aapnu Adbhut Sarjan\' (Gujarati) and \'Your Miracle in Making\' (English).' },
    ...
    { y: "2025", t: "Nikol, Ahmedabad & fifth National Fertility Award", d: 'Opened the <a href="/locations/ahmedabad/nikol" style="color:var(--plum)">Nikol</a> centre in east <a href="/locations/ahmedabad" style="color:var(--plum)">Ahmedabad</a> — making expert fertility care accessible across the city. Received \'Best IVF Chain in India — West\' (The Economic Times) and the National Fertility Award for the fifth time (2019–2025).' },
