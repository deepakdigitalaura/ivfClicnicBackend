...
const LOCALIZED_ROUTE_ROOTS = ["/", "/about-bfi", "/why-bfi", "/simple-treatment", "/safe-treatment", "/smart-treatment", "/success-benchmarks", "/history", "/doctors", "/infrastructure", "/contact", "/treatments", "/calculators"];
