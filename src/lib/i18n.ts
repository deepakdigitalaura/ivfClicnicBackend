...
const LOCALIZED_ROUTE_ROOTS = ["/", "/about-bfi", "/why-bfi", "/simple-treatment", "/safe-treatment", "/smart-treatment", "/success-benchmarks", "/history", "/doctors", "/infrastructure", "/suraksha-kavach", "/easy-emi", "/contact", "/treatments", "/calculators"];
...
export function localizeNavHref(href: string, locale: Locale): string {
  ...
  if (href.startsWith("/doctors/")) return href; // profiles not translated yet
