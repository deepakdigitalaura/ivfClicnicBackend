...
export const HOMEPAGE_DEFAULTS: HomepageData = {
  ...
  awards: {
    ...
    items: [
      ...
      { img: "/assets/awards/Group-106.webp", title: "Excellence in the Field of Medicine", desc: "IMA Gujarat — Dr. Himanshu Bavishi, first IVF graduate recipient" },
      { img: "/assets/awards/Group-107.webp", title: "Shreshtha Award", desc: "Gujarat Chief Minister · Dr. Himanshu & Dr. Falguni Bavishi" },
    ],
  },
  events: {
