...
const TREATMENT_KEYWORDS: Record<string, string[]> = {
  ...
  "fertility-preservation": ["fertility-preservation", "preserving-fertility", "preserve-fertility"],
  endometriosis: ["endometriosis"],
  azoospermia: ["azoospermia", "zero-sperm-count", "zero-sperm"],
  cryopreservation: ["cryopreservation", "freezing", "egg-freezing", "embryo-freezing", "sperm-freezing"],
